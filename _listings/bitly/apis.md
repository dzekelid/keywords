...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/keywords/master/_listings/bitly/apis.md
...
- name: Bitly Link API - Get User Save Custom Domain Keyword
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keywords/master/_listings/bitly/v3usersave-custom-domain-keyword-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/keywords/master/_listings/bitly/v3usersave-custom-domain-keyword-get-openapi.md
- name: Bitly Link API - Get User Save Custom Domain Keyword
  x-api-slug: v3usersave-custom-domain-keyword-get
  description: Get user save custom domain keyword.
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/1503-bitly.jpg
